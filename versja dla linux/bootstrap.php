 ...
 */
 Cookie::$salt = 'this is my new cookies';
 
 
/*zmiana
Session::$default = 'database';
Kohana_Cookie::$salt = md5('this is my new cookies');
Kohana_Cookie::$expiration = 1209600; // 14 days
Kohana_Cookie::$domain = '.inyoureyes.pl';*/
/*endofzmiana*/
 ...
 */
    ...
    Route::set('login', '(<controller>(/<action>(/<id>)))')
    ->defaults([
